            ...
            <template #container="{ closeCallback }">
                <div class="flex h-full flex-column">
                        ...
                        <ul class="p-3 m-0 list-none">
                            <li>
                                ...
                                <ul class="p-0 m-0 overflow-hidden list-none">
                                    <li>
                                        <a v-ripple class="flex p-3 transition-colors cursor-pointer align-items-center border-round text-700 hover:surface-100 transition-duration-150 p-ripple">
                                    ...
                                    <li>
                                        ...
                                        <ul class="hidden py-0 pl-3 pr-0 m-0 overflow-y-hidden list-none transition-all transition-duration-400 transition-ease-in-out">
                                            <li>
                                                <a
                                                    v-ripple
                                                    v-styleclass="{
                                    ...
                                    <li>
                                        <a v-ripple class="flex p-3 transition-colors cursor-pointer align-items-center border-round text-700 hover:surface-100 transition-duration-150 p-ripple">
                                            ...
                                            <span class="inline-flex ml-auto align-items-center justify-content-center bg-primary border-circle" style="min-width: 1.5rem; height: 1.5rem">3</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a v-ripple class="flex p-3 transition-colors cursor-pointer align-items-center border-round text-700 hover:surface-100 transition-duration-150 p-ripple">
                    ...
                    <div class="mt-auto">
                        ...
                        <a v-ripple class="flex gap-2 p-3 m-3 transition-colors cursor-pointer align-items-center border-round text-700 hover:surface-100 transition-duration-150 p-ripple">
